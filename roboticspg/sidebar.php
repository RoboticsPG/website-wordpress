...
<nav id="navbar-wrapper" class="navbar navbar-expand-lg navbar-light navbar-fixed-top">
    <a class="navbar-brand" id="menuFavicon" href="index.php#Top"><img id="navbar-logo" src="<?php echo get_template_directory_uri(); ?>/img/logo-square-grey.png" width="50px" alt="logo"></a>
